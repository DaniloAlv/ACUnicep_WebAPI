...
namespace ACUnicep.Data.Migrations
{
    ...
    [Migration("20210908005413_AtualizaNomeColunas")]
    partial class AtualizaNomeColunas
    {
            ...
            modelBuilder.Entity("ACUnicep.Domain.Entities.AtividadeComplementar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("COD_ATIVIDADE_COMPLEMENTAR");
                    ...
                    b.Property<DateTime>("DataSubmissao")
                        ...
                        .HasDefaultValue(new DateTime(2021, 9, 7, 21, 54, 12, 752, DateTimeKind.Local).AddTicks(1778))
